...
export interface ApiCanceledCanceled extends Struct.CollectionTypeSchema {
  collectionName: 'canceleds';
  info: {
    description: '';
    displayName: 'Canceled';
    pluralName: 'canceleds';
    singularName: 'canceled';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    CanceledOn: Schema.Attribute.DateTime;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    OrderedOn: Schema.Attribute.DateTime;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    state: Schema.Attribute.String & Schema.Attribute.DefaultTo<'confirmed'>;
    TotalPrice: Schema.Attribute.Integer & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiWomenWomen extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    image: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'> &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::women.women'> &
      Schema.Attribute.Private;
    price: Schema.Attribute.Decimal & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    stock: Schema.Attribute.Integer;
